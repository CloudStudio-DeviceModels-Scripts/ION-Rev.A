        ...
        switch (tag){
            ...
            case "/Turbo1/Ic":
                ...
                tagvalues.forEach(valueElement => {
                    ...
                    if (ValueData.v != null){
                        etv1.updateCosPhiSensorStatus(ValueData.v, ValueData.ts);    
                    }else {
                ...
                tagvalues.forEach(valueElement => {
                    ...
                    //etv1.updateActivePowerSensorStatus(ValueData.v, ValueData.ts);
