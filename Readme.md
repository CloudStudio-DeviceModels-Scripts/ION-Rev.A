...
# Parsing + Configuration Script – ION - Rev. A

This **Parsing + Configuration** script is designed for the **ION** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Parsing + Configuration – ION Rev. A

Este script de **Parsing + Configuration** está diseñado para el modelo **ION** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
